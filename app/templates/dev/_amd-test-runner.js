...
console.log('Loading <%= name.classified %> qUnit configurations.');

define(['text!amd-test-config.json','underscore'], function(testConfigString, undef) {

    console.log('Loading <%= name.classified %> qUnit tests.');
    ...
    return require(tests, function() {
        console.log('Initializing <%= name.classified %> qUnit tests.');
